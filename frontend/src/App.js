          ...
          <div className="border-t border-gray-200 px-4 py-5 sm:px-6">
            <form >
              ...
              <div className="component relative">
                ...
                <div className="flex mt-4 text-sm text-gray-900">
                  <div className="flex items-center">
                    {
                      countryFlag && <img src={countryFlag} alt="country-flag" width="20px" height="20px" />
              ...
              border border-gray-400 border-r-0 py-2 px-3 text-gray-700  bg-gray text-right">AED</span>
                      <input className="w-5/12 border border-gray-400 p-2
